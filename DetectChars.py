...
def detectCharsInPlates(listOfPossiblePlates):
    ...
    for possiblePlate in listOfPossiblePlates:          # for each possible plate, this is a big for loop that takes up most of the function
        ...
        if Main.showSteps == True: # show steps ###################################################
            ...
            cv2.imwrite("5a.png", possiblePlate.imgPlate)  # add matan

            cv2.imshow("5b", possiblePlate.imgGrayscale)
            cv2.imwrite("5b.png", possiblePlate.imgGrayscale)  # add matan

            cv2.imshow("5c", possiblePlate.imgThresh)
            cv2.imwrite("5c.png", possiblePlate.imgThresh)  # add matan
        ...
        if Main.showSteps == True: # show steps ###################################################
            ...
            cv2.imwrite("5d.png", possiblePlate.imgThresh)  # add matan
        ...
        if Main.showSteps == True: # show steps ###################################################
            ...
            cv2.imwrite("6.png", imgContours)  # add matan
        ...
        if Main.showSteps == True: # show steps ###################################################
            ...
            cv2.imwrite("7.png", imgContours)  # add matan
        ...
        if Main.showSteps == True: # show steps ###################################################
            ...
            cv2.imwrite("8.png", imgContours)  # add matan
        ...
        if Main.showSteps == True: # show steps ###################################################
            ...
            cv2.imwrite("9.png", imgContours)  # add matan
...
def recognizeCharsInPlate(imgThresh, listOfMatchingChars):
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        cv2.imwrite("10.png", imgThreshColor)  # add matan
