...
def detectPlatesInScene(imgOriginalScene):
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        cv2.imwrite("1a.png", imgGrayscaleScene)  # add matan
        cv2.imshow("1b", imgThreshScene)
        cv2.imwrite("1b.png", imgThreshScene)  # add matan
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        cv2.imwrite("2b.png", imgContours)  # add matan
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        cv2.imwrite("3.png", imgContours)  # add matan
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        cv2.imwrite("4a.png", imgContours)  # add matan
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.imwrite("4b.png", listOfPossiblePlates[i].imgPlate)  # add matan
...
def findPossibleCharsInScene(imgThresh):
    ...
    (contours,_) = cv2.findContours(imgThreshCopy, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)   # find all contours
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        cv2.imwrite("2a.png", imgContours)  # add matan
    # end if # show steps #########################################################################
